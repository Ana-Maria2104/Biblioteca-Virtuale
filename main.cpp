...
int main(int argc, char *argv[]) {
    ...
    // Selezione file JSON
    Json jManager;  // Oggetto automatico, non più puntatore
    ...
    // Caricamento dati
    QList<BibliotecaItem *> listaOggetti = jManager.loadList();
    ...
    EditCreatePage *editCreatePage = new EditCreatePage(&stackWidget, adminPage);

    // Connessioni per salvare prenotazioni e restituzioni
