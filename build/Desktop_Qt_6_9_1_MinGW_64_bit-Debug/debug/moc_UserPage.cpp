...
#include "../../../../../Biblioteca_D/Biblioteca_D_main/gui/UserPage.h"
...
template <> constexpr inline auto UserPage::qt_create_metaobjectdata<qt_meta_tag_ZN8UserPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'prenotaOggetto'
        QtMocHelpers::SlotData<void(Biblioteca *)>(9, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 10 },
        }}),
        // Slot 'restituisciOggetto'
        QtMocHelpers::SlotData<void(Biblioteca *)>(11, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 10 },
        }}),
    };
...
void UserPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->prenotaOggetto((*reinterpret_cast< std::add_pointer_t<Biblioteca*>>(_a[1]))); break;
        case 6: _t->restituisciOggetto((*reinterpret_cast< std::add_pointer_t<Biblioteca*>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (UserPage::*)(Biblioteca * )>(_a, &UserPage::itemUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void UserPage::itemUpdated(Biblioteca * _t1)
{
