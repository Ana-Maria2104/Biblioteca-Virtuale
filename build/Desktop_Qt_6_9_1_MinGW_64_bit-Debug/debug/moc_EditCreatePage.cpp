...
#include "../../../../../Biblioteca_D/Biblioteca_D_main/gui/EditCreatePage.h"
...
void EditCreatePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (EditCreatePage::*)(Biblioteca * )>(_a, &EditCreatePage::itemCreated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (EditCreatePage::*)(Biblioteca * )>(_a, &EditCreatePage::itemUpdated, 1))
            return;
    }
}
